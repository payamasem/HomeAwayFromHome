...
$( document ).ready(function() {
 // setting up initial variables
  ...
  function initialize(){
    ...
    //8000m / 5mile radius around center of map for coffee shops
    request = {
      location: center,
      radius: 8000,
      keyword: 'wine'
  ...
  // Clears red markers from map wheneber you move the location // 
  ...
  var proxy = 'https://cors-anywhere.herokuapp.com/';
    ...
    $.ajax({
          ...
          method: 'GET' 
            ...
            $("#content").html("<p>"+ response.query.pages[3234055].extract + "</p>")
        });
